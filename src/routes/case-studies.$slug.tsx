          ...
          <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
            <div className="space-y-10">
              ...
              <section>
                ...
                <p className="mt-4 text-lg font-medium leading-8 text-foreground">{study.outcome}</p>
              </section>
            </div>
            ...
            <aside className="glass-panel overflow-hidden rounded-2xl border border-white/15 text-panel-foreground shadow-xl">
              ...
              <div className="p-6">
                ...
                <h2 className="font-display mt-2 text-2xl leading-tight text-panel-foreground">{study.title}</h2>
